...
- `site.logo`: optional logo path
- `site.favicon`: optional favicon path
...
Static assets folder (copied as-is). Default: `public`. Set `false` to disable.
...
- `theme.publicDir`: theme public assets
